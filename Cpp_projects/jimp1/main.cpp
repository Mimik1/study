    ...
    if(iter->isoper)
      {
        ...
        /*Expr vare(nexpr,iter->w.oper, x,y);
          ...
          vare.eval();
          nexpr++;*/
        /*if(temp1.isop && temp2.isop)
        {
          Expr vare(nexpr,iter->w.oper, *(temp1.x_op), *(temp2.x_op));
          kl vare2(vare);
          stos.push(vare2);
          vare.eval();
          nexpr++;
        }
        if(temp1.isop && temp2.isexpr)
        {
          Expr vare(nexpr,iter->w.oper, *(temp1.x_op), *(temp2.x_expr));
          kl vare2(vare);
          stos.push(vare2);
          vare.eval();
          nexpr++;
        }
        if(temp1.isexpr && temp2.isexpr)
        {
          Expr vare(nexpr,iter->w.oper, *(temp1.x_expr), *(temp2.x_expr));
          kl vare2(vare);
          stos.push(vare2);
          vare.eval();
          nexpr++;
        }
        if(temp1.isexpr && temp2.isop)
        {
          Expr vare(nexpr,iter->w.oper, *(temp1.x_expr), *(temp2.x_op));
          kl vare2(vare);
          stos.push(vare2);
          vare.eval();
          nexpr++;
